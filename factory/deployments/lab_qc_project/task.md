# TAREA FACTORY — lab_qc_project

## Requerimiento
LIMS, HPLC, OOS, Data Integrity y CAPA

## Alcance
- Agentes a heredar: 
- Perfiles derivados: ninguno
- Agentes nuevos: ninguno (requieren aprobación humana previa)

## Restricciones
- Trabajas ÚNICAMENTE en este workspace: `/home/ing_cpmo/factory/workspaces/lab_qc_project/`
...
Ver manifest.yaml — sección quality_gates

## Pruebas obligatorias
- Quality gates G01-G13 deben pasar (G14 queda pendiente hasta deploy)
- Baterías de preguntas: G01-G13 + baterías por agente heredado
