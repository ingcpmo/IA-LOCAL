...
- **ancla provenance destino:** `Allen-Bradley 1756-L83E ControlLogix 5580 Controller with 10 MB User Memory, USB`
...
## Fila 10 · `refers_to` · RW-0005 p.40
...
## Fila 11 · `refers_to` · RW-0005 p.51
...
- **ancla provenance destino:** `FactoryTalk Historian DataLink Excel Reporting`
...
- **ancla provenance destino:** `XAH-00001-06 DO PCS Status Indicator on PCS-CP-01 PCS`
...
- **ancla provenance destino:** `Engineering Workstation PC located in Room 054 Grid:`
...
- **ancla provenance destino:** `A ThinManager® software solution provides the thin client architecture for the SCADA/HMI as`
...
- **ancla provenance destino:** `MicroLogix or CompactLogix.`
...
- **ancla provenance destino:** `from the FactoryTalk Linx driver itself.`
...
- **ancla provenance destino:** `CompactLogix (5380 series).`
...
## Fila 28 · `refers_to` · RW-0005 p.49
...
## Fila 29 · `refers_to` · RW-0005 p.40
...
## Fila 31 · `refers_to` · RW-0005 p.40

- **SAME_RELATION_AS_E1_2** = NO   ·   **PREVIOUS_VERDICT (E1-2, referencia)** = N/A (no estaba en E1-2)

- **claim (origen)** `clm-af2f6b575c6d046b`:

  > security features provided by both Microsoft Windows security and FactoryTalk Security.
...
- **destino** `system_component` `cmp-7227bca094122040` = **FactoryTalk Alarm and Events**

- **ancla provenance destino:** `is handled in the PLC and not in the FactoryTalk Alarm and Events`
...
## Fila 33 · `refers_to` · RW-0005 p.40
...
- **ancla provenance destino:** `Administrator and Maintenance login security levels.`
...
## Fila 34 · `refers_to` · RW-0005 p.54
...
## Fila 36 · `refers_to` · RW-0005 p.13
...
- **ancla provenance destino:** `PLC Interfaces (PCS-CP01 and other Vendor Systems) .....................................`
...
## Fila 37 · `refers_to` · RW-0005 p.45
...
## Fila 39 · `refers_to` · RW-0005 p.13
...
- **claim (origen)** `clm-3853f607fa65ca86`:

  > The access and manipulation of this system is protected through the FactoryTalk Security software
...
## Fila 41 · `refers_to` · RW-0005 p.13
...
## Fila 42 · `refers_to` · RW-0005 p.13
...
## Fila 43 · `refers_to` · RW-0005 p.45
...
- **ancla provenance destino:** `in the FactoryTalk Historian Site Edition (SE) software product.`
...
- **ancla provenance destino:** `OPC server for Rockwell Controllers provides the means to read/write values from/to the controller.`
...
## Fila 47 · `refers_to` · RW-0005 p.51
...
## Fila 49 · `refers_to` · RW-0005 p.40
...
## Fila 50 · `refers_to` · RW-0005 p.45
...
- **ancla provenance destino:** `Since an Administrator or Maintenance person may put any input point in SIMULATE and change its`
...
- **ancla provenance destino:** `control panel, an access layer Stratix Ethernet switch provides connectivity for the`
...
## Fila 58 · `refers_to` · RW-0005 p.51
...
## Fila 59 · `refers_to` · RW-0006 p.11
...
- **ancla provenance destino:** `vendor systems and other IT Systems, such as Windows Active Directory, NTP`
...
- **ancla provenance destino:** `control system platform is Allen-Bradley GuardLogix (1756-L72S).`
...
- **destino** `system_component` `cmp-52c7501dea780f15` = **FactoryTalk Alarm and Events**
...
- **claim (origen)** `clm-c856fc80a4b7cef5`:

  > are handled in the FactoryTalk Alarm and Events Server.

- **destino** `system_component` `cmp-9cf49a3f90dc8bcb` = **FactoryTalk Alarm and Events**

- **ancla provenance destino:** `are handled in the FactoryTalk Alarm and Events Server.`

- **provenance_hash** `cdc4eb4e5b219df052745b7205e4532bec6ef97deee5dce3dd92c0187c6302bd` · **ref** `literal_name`
