...
JUDGMENT_MODE_GAP_BLOCKED =     true (mecanismo cerrado en código y verificado con replay EXACTO de P2/P5 -- R2.3 §3, factory/tests/test_r2_3_p2_p5_judgment_replay.py, cero llamadas nuevas, mismos chunks + mismas 5 respuestas raw reales de PILOT_EXECUTION-2026-012; el pendiente de replay literal declarado en el cierre de R2.2 queda CERRADO)
